...
const DEFINITIONS: readonly DomainDefinition[] = [
  ...
  },
  {
    ...
    trainableSkills: [
      'how to identify and localize human female anatomical regions and landmarks',
      'how to identify and localize human male anatomical regions and landmarks',
      'how to distinguish sexually dimorphic anatomical structures and proportions',
      'how to map anatomical landmark coordinates and spatial relations to visual bounding boxes',
      'how to identify and localize animal body plans and comparative anatomical structures',
      'how to ground objects, spatial places, and scene entities in visual contexts',
