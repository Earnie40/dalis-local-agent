# Capability 39: Model ensemble voting for ordinary decisions

Category: `compute-and-model-routing`
Mode: `bounded_execution`

## Purpose

Provide DacaiLocalAgent with a reusable workflow for **Model ensemble voting for ordinary decisions**.
