# Capability 80: Predictive failure prevention
...
Provide DacaiLocalAgent with a reusable workflow for **Predictive failure prevention**.
...
- Predictions and simulations are advisory probabilities, not observed facts.
- Do not skip validation because a predicted path scored highly.
