# Capability 93: Organization/tenant policy learning

Category: `runtime-trust-and-interface`
Mode: `bounded_execution`

## Purpose

Provide DacaiLocalAgent with a reusable workflow for **Organization/tenant policy learning**.
...
- Retain only engineering/workflow signals needed for this capability.
- Never weaken permission requirements based solely on historical behavior.
- Learned policy is advisory until explicitly adopted.
- Never automatically reduce approval requirements or expand permissions.
