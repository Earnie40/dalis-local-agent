# Capability 47: Automatic architecture refactoring
...
Provide DacaiLocalAgent with a reusable workflow for **Automatic architecture refactoring**.
...
- Follow the normal DacaiLocalAgent permission, validation, review, and completion rules.
