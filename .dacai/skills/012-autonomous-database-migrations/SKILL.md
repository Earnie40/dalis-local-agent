# Capability 12: Autonomous database migrations
...
Provide DacaiLocalAgent with a reusable workflow for **Autonomous database migrations**.
...
- Database changes require an explicit bounded migration/repair workflow.
- Never alter production data automatically.
- Generate a migration/repair proposal and validation plan before any execution.
