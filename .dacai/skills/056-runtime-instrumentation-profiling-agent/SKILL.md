# Capability 56: Runtime instrumentation/profiling agent
...
Provide DacaiLocalAgent with a reusable workflow for **Runtime instrumentation/profiling agent**.
...
- Collect measurements before optimization.
- Keep before/after performance evidence.
- Do not trade correctness or security for benchmark improvements.
