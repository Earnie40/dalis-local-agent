# Capability 97: Autonomous billing/metering for agent labor
...
Provide DacaiLocalAgent with a reusable workflow for **Autonomous billing/metering for agent labor**.
...
- Meter actual observed usage only.
- Internal accounting must not itself authorize external financial transactions.
