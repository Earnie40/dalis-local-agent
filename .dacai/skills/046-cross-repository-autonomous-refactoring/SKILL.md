# Capability 46: Cross-repository autonomous refactoring

Category: `memory-and-codebase-intelligence`
Mode: `bounded_execution`

## Purpose

Provide DacaiLocalAgent with a reusable workflow for **Cross-repository autonomous refactoring**.
...
- Preserve the current working tree and existing user changes.
- Use isolated branches/worktrees when available.
- Never discard or overwrite competing work merely to simplify merging.
- Operate only across explicitly registered workspaces/repositories.
- Keep repository boundaries visible in evidence and mutation records.
