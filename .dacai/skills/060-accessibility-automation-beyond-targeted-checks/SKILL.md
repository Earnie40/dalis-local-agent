# Capability 60: Accessibility automation beyond targeted checks
...
Provide DacaiLocalAgent with a reusable workflow for **Accessibility automation beyond targeted checks**.
...
- Visual/accessibility findings are evidence, not permission to rewrite unrelated design.
- Keep baseline changes reviewable and explain intentional visual differences.
