# Capability 23: Credential discovery/recovery agent
...
Provide DacaiLocalAgent with a reusable workflow for **Credential discovery/recovery agent**.
...
- Never expose secret values in logs, prompts, traces, training data, or search queries.
- Do not broadly hunt through unrelated user files for credentials.
