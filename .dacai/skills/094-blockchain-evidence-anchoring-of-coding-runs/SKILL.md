# Capability 94: Blockchain/evidence anchoring of coding runs
...
Provide DacaiLocalAgent with a reusable workflow for **Blockchain/evidence anchoring of coding runs**.
