# Capability 75: Autonomous release notes/changelog generation as a gate

Category: `contracts-release-and-documentation`
Mode: `bounded_execution`

## Purpose

Provide DacaiLocalAgent with a reusable workflow for **Autonomous release notes/changelog generation as a gate**.
...
- Derived release/docs artifacts must be grounded in actual diff/test/evidence state.
- Do not mark a release ready merely because documentation generation succeeded.
