# Capability 72: Test-user lifecycle management
...
Provide DacaiLocalAgent with a reusable workflow for **Test-user lifecycle management**.
...
- Generated fixtures/users must be clearly marked test-only.
- Never create or delete real customer/user accounts automatically.
