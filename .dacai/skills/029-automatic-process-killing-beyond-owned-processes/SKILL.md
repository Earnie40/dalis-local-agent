# Capability 29: Automatic process killing beyond owned processes
...
Provide DacaiLocalAgent with a reusable workflow for **Automatic process killing beyond owned processes**.
