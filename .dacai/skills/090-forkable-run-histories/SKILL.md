# Capability 90: Forkable run histories
...
Provide DacaiLocalAgent with a reusable workflow for **Forkable run histories**.
...
- git
- durable checkpoint/event storage
...
- Replay/fork operations must not mutate the original historical run.
