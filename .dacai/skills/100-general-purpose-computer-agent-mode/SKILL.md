# Capability 100: General-purpose computer agent mode
...
Provide DacaiLocalAgent with a reusable workflow for **General-purpose computer agent mode**.
...
- General external computer/account operation is not implicitly authorized.
- Do not log into arbitrary sites, accept terms, purchase services, or change account state automatically.
- Use bounded registered targets only.
