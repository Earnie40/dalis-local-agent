# Capability 5: Self-training from successful coding traces
...
Provide DacaiLocalAgent with a reusable workflow for **Self-training from successful coding traces**.
