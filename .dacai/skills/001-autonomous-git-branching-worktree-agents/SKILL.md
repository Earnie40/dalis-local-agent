# Capability 1: Autonomous Git branching/worktree agents

Category: `engineering-and-release`
Mode: `bounded_execution`

## Purpose

Provide DacaiLocalAgent with a reusable workflow for **Autonomous Git branching/worktree agents**.
